...
public static void main(String[] args) {
    ...
    ImageIcon title = new ImageIcon((Game.class.getResource("title.gif")));
    ImageIcon letter = new ImageIcon((Game.class.getResource("let.jpg")));
    ImageIcon welcome = new ImageIcon((Game.class.getResource("welcomePoster.jpg")));
    ImageIcon dad = new ImageIcon((Game.class.getResource("Dad.gif")));
    ImageIcon jumpscare = new ImageIcon((Game.class.getResource("maxresdefault.jpg")));

    ImageIcon pt = new ImageIcon((Game.class.getResource("PT.png")));
...
ImageIcon yes = new ImageIcon((Game.class.getResource("Untitled_Artwork-1.png"))); // 325 x 240 size
...
System.out.println("A periodic table will be provided.");
Image3 gui3 = new Image3();
gui3.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
...
ImageIcon evil = new ImageIcon((Game.class.getResource("Evil.png"))); 

ImageIcon scary = new ImageIcon((Game.class.getResource("Scary.png"))); // shrink

ImageIcon surprised = new ImageIcon((Game.class.getResource("Surprised.png"))); //shrink
...
questions[0] = new ImageIcon((Game.class.getResource("q1.jpeg")));
questions[1] = new ImageIcon((Game.class.getResource("q2.jpeg")));
questions[2] = new ImageIcon((Game.class.getResource("q3.jpeg")));
questions[3] = new ImageIcon((Game.class.getResource("q4.jpeg")));
questions[4] = new ImageIcon((Game.class.getResource("q5.jpeg")));
questions[5] = new ImageIcon((Game.class.getResource("q6.jpeg")));
...
if(GameFunctions.showPoints(false)<15) {
...
else if(GameFunctions.showPoints(false) > 14 && GameFunctions.showPoints(false) < 30) {
...
else if(GameFunctions.showPoints(false) > 29) {
